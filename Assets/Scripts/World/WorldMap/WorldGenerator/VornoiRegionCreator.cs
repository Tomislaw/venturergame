...
namespace WorldGenerator
{
    ...
    public class VornoiRegionCreator
    {
        ...
        public Task<List<Region>> Generate(CancellationToken cancellationToken = new CancellationToken())
        {
            Task<List<Region>> task = null;
            task = Task.Run(() =>
            {
                var sities = GenerateSities(cancellationToken);
                return CreateRegions(sities, cancellationToken);
            });
            return task;
        }

        private List<ExtendedFortuneSite> GenerateSities(CancellationToken cancellationToken)
        {
        ...
        private List<Region> CreateRegions(List<ExtendedFortuneSite> cells, CancellationToken cancellationToken)
        {
